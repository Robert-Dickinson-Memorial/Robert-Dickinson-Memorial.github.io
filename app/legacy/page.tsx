...
import { getFeaturedMemoryQuotes, getSiteContent, type LegacyChapterPhoto } from "../site-data";
...
export default async function LegacyPage() {
  const [content, featuredQuotes] = await Promise.all([getSiteContent(), getFeaturedMemoryQuotes()]);
