...
export default async function ManagePage() {
  ...
  const [eventResult, mediaResult, editorResult, memoryResult] = env.DB ? await Promise.all([
    ...
    env.DB.prepare(`SELECT id, name, relationship, title, story, photo_key AS photoKey FROM memories WHERE status = 'approved' ORDER BY created_at DESC, id DESC`).all<PublishedMemory>(),
  ...
  return (
    <main className="manage-shell">
      <header className="manage-header">
        ...
        <p>Edit the entire public memorial directly: typography, every page label and paragraph, the homepage headshot and artwork, affiliations, scientific chapters and photographs, honors, events, gallery media, and memories.</p>
        <nav className="manager-nav"><a href="#edit-style">Typography</a><a href="#edit-images">Site images</a><a href="#edit-all-copy">All page text</a><a href="#edit-story">Story</a><a href="#edit-home-legacy">Homepage legacy</a><a href="#edit-life">His Life</a><a href="#edit-legacy">Scientific chapters</a><a href="#edit-legacy-threads">Research threads</a><a href="#edit-honors">Honors</a><a href="#edit-events">Events</a><a href="#edit-gallery">Photos & videos</a>{isOwnerEmail(user.email) && <a href="#edit-access">Editor access</a>}<a href="/review"><MessageSquareText size={16} /> Review memories</a><a href="/memory-book"><BookOpen size={16} /> Preview book</a></nav>
      </header>
